...
<body class="min-h-screen">
        ...
        <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-[var(--color-dark-card)] border-r border-[var(--color-dark-border)] flex flex-col h-full transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out" id="sidebar">
            ...
            <div class="p-4 border-t border-[var(--color-dark-border)]">
                <div class="flex items-center gap-3">
                    ...
                    <button type="button" onclick="showLogoutModal()" class="p-1.5 rounded-md hover:bg-[rgba(239,68,68,0.15)] text-[var(--color-text-muted)] hover:text-[var(--color-danger)] transition-colors cursor-pointer" title="Logout">
    ...
    <div id="logout-modal" style="display:none" class="fixed inset-0 z-50 items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
        <div class="bg-[var(--color-dark-card)] border border-[var(--color-dark-border)] rounded-xl w-full max-w-sm overflow-hidden shadow-2xl">
            <div class="p-6 text-center">
                ...
                <h3 class="text-lg font-bold text-[var(--color-text-primary)] mb-2">Yakin ingin keluar?</h3>
                <p class="text-sm text-[var(--color-text-muted)] mb-6">Anda akan kembali ke halaman login.</p>
                <div class="flex gap-3">
                    <button type="button" onclick="hideLogoutModal()" class="flex-1 py-2.5 text-sm font-semibold bg-[var(--color-dark-card)] text-[var(--color-text-primary)] border border-[var(--color-dark-border)] hover:border-[var(--color-brand)] transition-all duration-200 rounded-lg cursor-pointer">Batal</button>
                    <button type="button" onclick="submitLogout()" class="flex-1 py-2.5 text-sm font-bold bg-[var(--color-danger)] text-white hover:bg-[#dc2626] transition-all duration-200 rounded-lg cursor-pointer">Keluar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        function showLogoutModal() {
            var el = document.getElementById('logout-modal');
